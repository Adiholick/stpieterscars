<html lang="en">
  ...
  <style>
    ...
    body { background-color: rgb(217, 217, 217) !important; }
  </style>
  <script>
    $(function() {
      Login.init()
  ...
  <div class="col-md-6 hidden-sm hidden-xs" style="height: 100vh; overflow-y: auto;">
        <a href="<?php echo base_url(); ?>" class="logo"><img data-wow-duration="2s" data-wow-delay="4s" src="<?php echo base_url(); ?>uploads/global/logo.png" class="wow fadeIn img-responsive center-block"/></a>
  </div>
  ...
  <div class="col-md-8">
    ...
    <p data-wow-duration="2s" data-wow-delay="2s" class="text-center wow fadeInDown" style="color:#919191"> Powered by  <a target="_blank" style="color: #474747" href="http://phptravels.com"><b>PHPTRAVELS</b></a> <a href="http://phptravels.com/change-log/#<?php echo PT_VERSION; ?>"></a><?php echo PT_VERSION; ?></p>
   </div>
   </div>
