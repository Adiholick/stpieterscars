...
<div class="row form-group">
  ...
  <div class="col-xs-6 col-sm-6 col-md-2">
    <button data-toggle="modal" data-target="#quickbook" class="btn btn-danger btn-block">
      <div class="h5"><i class="fa fa-dashboard fa-lg"></i> Snelle boeking</div>
    </button>
  </div>
  <?php } ?>
  <div class="col-xs-6 col-sm-6 col-md-2">
    <form action="<?php echo base_url().$this->uri->segment(1); ?>/bookings/" method="post">
      <button type="submit" class="btn btn-primary btn-block">
        <div class="h5"><i class="fa fa-bar-chart-o fa-lg"></i> Boekingen</div>
      </button>
    </form>
  </div>
  <?php if($isadmin){ ?>
  <div class="col-xs-6 col-sm-6 col-md-2">
    <form action="<?php echo base_url(); ?>admin/cms/" method="post">
      <button type="submit" class="btn btn-info btn-block">
        <div class="h5"><i class="fa fa-list-alt fa-lg"></i> &nbsp; CMS pagina's</div>
      </button>
    </form>
  </div>
  <?php if($blogenabled){ ?>
  ...
  <div class="col-xs-6 col-sm-6 col-md-2">
    <form action="<?php echo base_url(); ?>admin/newsletter/" method="post">
      <button type="submit" role="button" class="btn btn-warning btn-block">
        <div class="h5"><i class="fa fa-envelope fa-lg"></i> Stuur nieuwsbrief</div>
      </button>
    </form>
  </div>
  <?php } ?>
  <div class="col-xs-6 col-sm-6 col-md-2">
    <form action="<?php echo base_url(); ?>admin/backup/" method="post">
      <button type="submit" role="button" class="btn btn-default btn-block">
        <div class="h5"><i class="fa fa-inbox fa-lg"></i> Backup Database</div>
      </button>
    </form>
  </div>
  <?php } ?>
...
<div class="row">
  <div class="col-md-8">
    <div class="panel panel-default">
      <div class="panel-heading">Omzet overzicht</div>
          ...
          <script type="text/javascript">
            $(function () {
                $('#container').highcharts({
                    title: {
                        text: 'Boekingen laatste 30 dagen raport',
                        x: -20 //center
                    },
                    xAxis: {
  ...
  <div class="col-md-4">
    <div class="panel panel-default">
      <div class="panel-heading">Boeking overzicht </div>
      <div class="panel-body">
        <div class="block">
          <div class="pad8 rev-bg">
            ...
            <div class="col-lg-8 col-md-12 col-sm-7">
              <div class="text-left">
                <h4><strong>Boekingen vandaag</strong></h4>
                <p>Gisteren : <?php echo $yesterday->totalCount + $yesterdayExpedia->totalCount;?></p>
                <hr class="mtb04">
                <span class="text-success"><strong>Betaald :</strong> <?php echo $today->paidAmount + $todayExpedia->paidAmount;?></span>
                <div class="clearfix"></div>
                <span class="text-danger"><strong>Niet betaald :</strong> <?php echo $today->unpaidAmount;?></span>
              </div>
            </div>
            <div class="clearfix"></div>
          </div>
        ...
        <div class="block">
          <div class="pad8 rev-bg">
            ...
            <div class="col-lg-8 col-md-12 col-sm-7">
              <div class="text-left">
                <h4><strong>Laatste 30 dagen</strong></h4>
                <p>Laatste 60 dagen : <?php echo $sixtyDays->totalCount + $sixtyDaysExpedia->totalCount;?></p>
                <hr class="mtb04">
                <span class="text-success"><strong>Betaald :</strong> <?php echo $thirtyDays->paidAmount + $thirtyDaysExpedia->paidAmount;?></span>
                <div class="clearfix"></div>
                <span class="text-danger"><strong>Niet betaald :</strong> <?php echo $thirtyDays->unpaidAmount;?></span>
              </div>
            </div>
            <div class="clearfix"></div>
          </div>
        ...
        <div class="block hidden-md hiddin-sm hidden-xs">
          <div class="pad8 rev-bg">
            ...
            <div class="col-lg-8 col-md-12 col-sm-7">
              <div class="text-left">
                <h4><strong>Laatste 90 dagen</strong></h4>
                <p>Laatste 180 dagen : <?php echo $oneEightyDays->totalCount + $oneEightyDaysExpedia->totalCount;?></p>
                <hr class="mtb04">
                <span class="text-success"><strong>Betaald :</strong> <?php echo $nintyDays->paidAmount + $nintyDaysExpedia->paidAmount;?></span>
                <div class="clearfix"></div>
                <span class="text-danger"><strong>Niet betaald :</strong> <?php echo $nintyDays->unpaidAmount;?></span>
              </div>
            </div>
            <div class="clearfix"></div>
          </div>
  ...
  <div class="col-md-12">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
       <div class="pull-left"> <span class="fa fa-bar-chart-o"></span> Bezoekersstatistieken van <?php echo date('F', time()); ?></div>
    ...
    <div class="modal-content">
      <form action="<?php echo base_url().$this->uri->segment(1); ?>/quickbooking/" method="GET">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Snelle boeking</h4>
        </div>
        <div class="modal-body form-horizontal">
          <div class="form-group">
            <label class="col-md-3 control-label" >Reken BTW aan</label>
            <div class="col-md-4">
...
<script type="text/javascript">
  ...
  $.alert.open('confirm', 'Bent u zeker dat u de bezoekersdata wil resetten?', function(answer) {
   if(answer == 'yes'){
