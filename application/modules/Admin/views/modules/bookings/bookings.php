<script type="text/javascript">
  ...
  if($.trim(sterm).length < 1){
    ...
    $.ajax({
        ...
        if(count_checked == 0) {
  $.alert.open('info', 'Selecteer een boeking die je wil verwijderen');
          return false;}
  $.alert.open('Bevestigen', 'Ben je zeker dat je dit wil verwijderen?', function(answer) {
          if (answer == 'yes')
    ...
    location.reload();
        ...
        var count_checked = $("[name='booking_ids[]']:checked").length;
        if(count_checked == 0) {
  $.alert.open('info', 'Selecteer een boeking die je als betaald wil zetten.');
          return false;}
  $.alert.open('Bevestigen', 'Ben je zeker dat je deze boeking als betaald wil zetten?', function(answer) {
      if (answer == 'yes')
     ...
     var count_checked = $("[name='booking_ids[]']:checked").length;
     if(count_checked == 0){
  $.alert.open('info', 'Selecteer een boeking die je als onbetaald wil zetten.');
          return false;
           }
  $.alert.open('Bevestigen', 'Ben je zeker dat je deze boeking als betaald wil zetten?', function(answer) {
     if (answer == 'yes')
